...
namespace CodeWarsKatas
{
     ...
     * 
     * Going to one direction and coming back the opposite direction right away is a needless effort. Since 
     * this is the wild west, with dreadfull weather and not much water, it's important to save yourself 
     ...
     * 
     * [North, South, South, East, West, North, West]
     * You can immediatly see that going "NORTH" and immediately "SOUTH" is not reasonable, better stay to 
     * the same place! So the task is to give to the man a simplified version of the plan. A better plan in 
     * this case is simply:
     * 
     * ["WEST"]
     * or
     ...
     * Other examples:
     * ---------------
     * In ["NORTH", "SOUTH", "EAST", "WEST"], the direction "NORTH" + "SOUTH" is going north and coming back 
     * right away.
     * 
